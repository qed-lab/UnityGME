...
namespace Mediation.KnowledgeTools
{
    ...
    public class EnvironmentModel
    {
        ...
        // The chronology of actions the player is aware of.
        private List<IOperator> knownChronology;
        ...
        /// <summary>
        /// Gets the chronology known to the model.
        /// </summary>
        /// <value>A list of operators that constitute the known chronology.</value>
        public List<IOperator> KnownChronology {
            get { return this.knownChronology; }
        }
        ...
        public EnvironmentModel(string agentName, Domain planningDomain, Problem planningProblem)
        {
            ...
            this.knownChronology = new List<IOperator>();
        ...
        /// <summary>
        /// Adds the given literal to the model if it is not already there. 
        /// Bypasses the need for direct observation by some micro-theory.
        /// </summary>
        /// <param name="predicate">A literal sentence to expand this EnvironmentModel with.</param>
        public void InformLiteral(IPredicate literal)
        {
            ...
            // Add each of the literal's terms as known objects to the model (if they aren't there already).
//            foreach (ITerm term in literal.Terms)
//            {
//                if (term.Bound)
//                {
//                    IObject termObj = this.planningProblem.Objects.Find(t => t.Name.Equals(term.Constant));
//
//                    if (!this.knownObjects.Contains(termObj))
//                        this.knownObjects.Add(termObj);
//                }
//            }
        }

        /// <summary>
        /// Adds the given literals to the model if they are not already there.
        /// Bypasses the need for direct observation by some micro-theory.
        /// </summary>
        /// <param name="literals">Literals.</param>
        public void InformLiterals(List<IPredicate> literals)
        {
            foreach (IPredicate literal in literals)
                InformLiteral(literal);
        }
        ...
        /// <summary>
        /// Compiles the necessary elements of this model to create a chronology.
        /// </summary>
        /// <returns>The chronology that is known to this model.</returns>
        public List<IOperator> CompileChronology( )
        {
            return knownChronology;
        }
        ...
        private bool KnowsLiteral(IPredicate literal)
        {
            return (this.knownCurrentState.InState(literal));
        }
